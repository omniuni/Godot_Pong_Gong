...
var menu = preload("res://Scenes/screen_menu.tscn")
var app = preload("res://Scenes/screen_main.tscn")
var settings = preload("res://Scenes/screen_settings.tscn")
var help = preload("res://Scenes/screen_help.tscn")
